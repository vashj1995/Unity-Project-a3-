...
{
    public ColliderBase objectA;
    public ColliderBase objectB;
...
[RequireComponent(typeof(Kinematics))]
...
public abstract class ColliderBase : MonoBehaviour
{
    ...
    public Kinematics kinematicsObject;

    public void Start()
    {
        kinematicsObject = GetComponent<Kinematics>();
    }
}
